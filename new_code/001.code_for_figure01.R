...
# loading data
invasion.list <- fread("./Data/001.alien.checklist_online.availability.csv")
str(invasion.list)
...
# add a new column named pt_proportion, which is proportion of number of alien # plants within each invasion status to total number of alien plants in China
